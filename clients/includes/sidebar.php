...
<ul class="collection with-header">
  ...
  <li class="collection-item <?php if(isset($_GET["my_applications"])){echo "active deep-purple lighten-1";} ?>"><i class="material-icons left">list</i><a href="apply.php?my_applications" class="black-text">My Applications <span class="badge deep-purple lighten-1 white-text"><?php    echo $ap_count;?></span></a></li>
